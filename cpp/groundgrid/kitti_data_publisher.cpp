...
void Init(){
  const std::string pcFileName = "/home/aiyang/SemanticKITTI/dataset/sequences/00/velodyne/000001.bin";
  const std::string poseFileName = "/home/aiyang/SemanticKITTI/dataset/sequences/00/poses.txt";
...
void sendClouds(){
  const std::string labelFileName = "/home/aiyang/SemanticKITTI/dataset/sequences/00/labels/000001.label";
